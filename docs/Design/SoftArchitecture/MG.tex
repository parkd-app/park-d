...
\item[\refstepcounter{acnum} \actheacnum \label{ac3}:] The implementation of
...
\begin{description}
\item[\refstepcounter{ucnum} \uctheucnum \label{ucIO}:] The type of information
...
\begin{description}
\item [\refstepcounter{mnum} \mthemnum \label{mCameraCapture}:] Camera Capture
Module
\end{description}
